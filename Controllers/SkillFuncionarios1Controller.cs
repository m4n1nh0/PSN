...
{
    public class SkillFuncionarios1Controller : Controller
    {
        private PSN2018Context db = new PSN2018Context();

        // GET: SkillFuncionarios1
        public ActionResult Index()
        {
            return View(db.SkillFuncionarios.ToList());
        }

        // GET: SkillFuncionarios1/Details/5
        ...
        // GET: SkillFuncionarios1/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: SkillFuncionarios1/Create
        ...
        // POST: SkillFuncionarios1/Edit/5
        // Para se proteger de mais ataques, ative as propriedades específicas a que você quer se conectar. Para 
        // obter mais detalhes, consulte https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: SkillFuncionarios1/Delete/5
        ...
        // POST: SkillFuncionarios1/Delete/5
